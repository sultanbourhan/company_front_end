        ...
        <div className="blor">
          <div className="createad">
            ...
            <select onChange={(e)=>settitle(e.target.value)}>
              <option hidden disabled selected>نوع الإعلان</option>
              <option value="Test1">Test1</option>
              <option value="Test2">Test2</option>
              <option value="Test3">Test3</option>
            </select>
            <p style={{color: "red"}}>{descriptionerr}</p>
            <textarea value={description} onChange={(e)=>setdescription(e.target.value)} placeholder="اكتب وصفا هنا"></textarea>
      ...
      <div className="container">
        <div className="mains">
          ...
          <div className={iconn ? "filter menu-show" : "filter"}>
            <div className="fex">
              <FontAwesomeIcon
                ...
                icon={faTimes}
              />
              <p className="active" onClick={() => { setcategory_id(""); seticonn(false); }}>جميع الفئات</p>
              {
          ...
          <div className="advertisement">
            ...
            {
              advertisement.length < 1 ? <h2>لا يوجد اعلانات</h2> : advertisement.map((adv)=>{
                return(
