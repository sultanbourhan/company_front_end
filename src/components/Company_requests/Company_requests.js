      ...
      .catch((error) => {
        ...
        if (error.response && error.response.data.errors) {
          ...
          errors.forEach((err) => {
            ...
            if (err.path === "subscription") {
              const e_error = errors.filter((e) => e.path === "subscription");
          ...
          if (error.response.data.message) {
            if(error.response.data.message === "jwt must be provided"){
              setapi_err("يجب تسجيل الدخول اولا")
            }else{
              setapi_err(error.response.data.message);
            }
